...
- get trades every 5 sec
- start/stop paper trading endpoint
- cleanup execution

## Version 2026.8.5

- history startdate configurable

## Version 2026.8.4

- Fix Historical Service

## Version 2026.8.3

- Fix Historical Service
- Trade Storage removed
...
- NotificationHub added

## Version 2025.06.2

- Endpoint: Start optimization of strategy parameters
- Endpoint: Trigger kafka rate stream
