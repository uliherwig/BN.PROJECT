...
public class IdentityRepository : IIdentityRepository
{
    ...
    public IdentityRepository(BNProjectDbContext context, ILogger<IdentityRepository> logger)
    {
        _context = context;
        _logger = logger;
    }
    ...
    public async Task<Session> GetSessionByUserIdAsync(Guid sessionId)
    {
        var userSession = await _context.Sessions.FirstOrDefaultAsync(s => s.SessionId == sessionId);
        return userSession;
    }
    ...
    {
        var roleToUpdate = await _context.Roles.FindAsync(role.RoleName);
    ...
    {
        var sessionToUpdate = await _context.Sessions.FindAsync(session.UserId);
